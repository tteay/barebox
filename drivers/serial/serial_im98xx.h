/**
 * @file
 * @brief Serial IM98XX header
 *
 * FileName: drivers/serial/serial_ns16550.h
 *
 * @code struct IM98XX @endcode
 * Register definitions for IM98XX device
 */
/*
...
#ifndef __SERIAL_IM98XX__H
#define  __SERIAL_IM98XX__H
