 ...
 * MA 02111-1307 USA
 */
#ifndef __MACH_IM98XX_CONFIG_H
#define __MACH_IM98XX_CONFIG_H

/** define CFG_MALLOC_LEN from Kconfig define */
#define CFG_MALLOC_LEN	CONFIG_IM98XX_MALLOC_LEN

/** define CONFIG_STACKSIZE from Kconfig define */
#define CONFIG_STACKSIZE	CONFIG_IM98XX_CONFIG_STACKSIZE

#endif /* __MACH_IM98XX_CONFIG_H */
