...
#elif defined(CONFIG_SDRAM_DEVICE_SAMSUNG_K524G2GACG_CONFIG)

#if (defined(CONFIG_IM98XX_XMEM_CLOCK_130_CONFIG) || \
     defined(CONFIG_IM98XX_XMEM_CLOCK_104_CONFIG) || \
     defined(CONFIG_IM98XX_XMEM_CLOCK_78_CONFIG))
	0x3, 0x2, 0x2, 0x3, 0x3,
		0x3, 0x0, 0x9, 0x0, 0x0, 0x3, 0x0,
		0x3, 0x0, 0x9, 0x0, 0x0, 0x3, 0x0,
		0x3, 0x0, 0x9, 0x0, 0x0, 0x3, 0x0,
		0x3, 0x0, 0x9, 0x0, 0x0, 0x3, 0x0,
		0x27, 0x27, 0x27, 0x27,
...
/* V3 default parameters */
	...
	DenaliPHY_Write(DENALY_PHY_09, 0x00800004);
	DenaliPHY_Write(DENALY_PHY_10, 0xa0104633);
	DenaliPHY_Write(DENALY_PHY_11, 0x00080D04);
	DenaliPHY_Write(DENALY_PHY_12, 0xa0104633);
	DenaliPHY_Write(DENALY_PHY_13, 0x00080E04);
	DenaliPHY_Write(DENALY_PHY_14, 0xa0104633);
	DenaliPHY_Write(DENALY_PHY_15, 0x00080D04);
	DenaliPHY_Write(DENALY_PHY_16, 0xa0104633);
	DenaliPHY_Write(DENALY_PHY_17, 0x00080E04);
	DenaliPHY_Write(DENALY_PHY_18, 0x00000000);
	DenaliPHY_Write(DENALY_PHY_19, 0x00000071);
	DenaliPHY_Write(DENALY_PHY_20, 0x0006000f);
	DenaliPHY_Write(DENALY_PHY_21, 0x00000000);
	...
	DenaliPHY_Write(DENALY_PHY_09, 0x00800004);
	DenaliPHY_Write(DENALY_PHY_10, 0xa0104633);
	DenaliPHY_Write(DENALY_PHY_11, 0x00081904);
	DenaliPHY_Write(DENALY_PHY_12, 0xa0104633);
	DenaliPHY_Write(DENALY_PHY_13, 0x00081f04);
	DenaliPHY_Write(DENALY_PHY_14, 0xa0104633);
	DenaliPHY_Write(DENALY_PHY_15, 0x00081604);
	DenaliPHY_Write(DENALY_PHY_16, 0xa0104633);
	DenaliPHY_Write(DENALY_PHY_17, 0x00081c04);
	DenaliPHY_Write(DENALY_PHY_18, 0x00000000);
	DenaliPHY_Write(DENALY_PHY_19, 0x00000071);
	DenaliPHY_Write(DENALY_PHY_20, 0x0006000f);
	DenaliPHY_Write(DENALY_PHY_21, 0x00000000);
...
static int im98xx_devices_init(void)
{
	...
	barebox_add_memory_bank("ram1", 0x1ffe0000, 128*1024);//sram
	barebox_add_memory_bank("ram2", 0x407f2000, 128*1024);//imei
	barebox_add_memory_bank("ram3", 0x40000000, 128*1024);//icon
	barebox_add_memory_bank("ram0", 0x40800000, 192*1024*1024);//sdram
	armlinux_set_bootparams((void *)(0x40800000 + 0x100));//sdram base:0x40800000
	armlinux_set_architecture(MACH_TYPE_IM98XXV3);
failed:
	return ret;
}
