...
/* V2: VIO18 power good debounce enable (2504b to support) */
...
static int im98xx_devices_init(void)
{
	...
	armlinux_set_architecture(MACH_TYPE_IM98XXV2);
failed:
	return ret;
}
